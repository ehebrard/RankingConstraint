...
def get_cmdline():
    ...
    parser.add_argument('--stat',type=str,default="RUNTIME",help='statistic',choices=['RUNTIME','NODES','BACKTRACKS','FAILS','RESTARTS','OPTIMAL','OBJECTIVE','NUMFINISHED'])
...
if __name__ == '__main__':
    ...
    plot(average, methods, lengths, stat)
